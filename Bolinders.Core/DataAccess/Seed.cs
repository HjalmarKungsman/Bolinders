        ...
        public static void FillIfEmpty(ApplicationDbContext ctx, UserManager<ApplicationUser> userManager)
        {
            ...
            if (!ctx.Vehicles.Any())
            {
                ...
                var vehicles = new List<Vehicle>
                {
                    ...
                    new Vehicle { Id = carId, RegistrationNumber = "UYM207", MakeId = 29, Model = "9-3", ModelDescription = "2.0 Turbo", BodyType = BodyType.B2, Colour="Svart", Horsepowers = 183, FacilityId = "BB2", FuelType = FuelType.F2, Gearbox = Gearbox.G1, Leasable = false, Mileage = 16240, Used = false, Year = 2007, Price = 62500 },
                    new Vehicle { RegistrationNumber = "GRT912", MakeId = 30, Model = "M3", ModelDescription = "C2", BodyType = BodyType.B3, Colour="Vit", Horsepowers = 305, FacilityId = "BB2", FuelType = FuelType.F3, Gearbox = Gearbox.G1, Leasable = true, Mileage = 3250, Used = true, Year = 2014, Price = 32000 },
                    new Vehicle { RegistrationNumber = "BVO184", MakeId = 30, Model = "330ci", ModelDescription = "SE", BodyType = BodyType.B4, Colour="Silver", Horsepowers = 285, FacilityId = "BB3", FuelType = FuelType.F4, Gearbox = Gearbox.G1, Leasable = false, Mileage = 30000, Used = true, Year = 1996, Price = 42000 },
                    new Vehicle { RegistrationNumber = "RTF824", MakeId = 37, Model = "A4", ModelDescription = "Mark II", BodyType = BodyType.B5, Colour="Silver", Horsepowers = 170, FacilityId = "BB2", FuelType = FuelType.F5, Gearbox = Gearbox.G1, Leasable = false, Mileage = 25000, Used = true, Year = 2003, Price = 31000 },
                    ...
                    new Vehicle { RegistrationNumber = "GRS267", MakeId = 35, Model = "Cayenne", ModelDescription = "SE", BodyType = BodyType.B7, Colour="Svart", Horsepowers = 300, FacilityId = "BB3", FuelType = FuelType.F7, Gearbox = Gearbox.G1, Leasable = true, Mileage = 13223, Used = true, Year = 2012, Price = 225000 },
                    new Vehicle { RegistrationNumber = "NKD972", MakeId = 37, Model = "RS6", ModelDescription = "Bison X", BodyType = BodyType.B8, Colour="Grå", Horsepowers = 375, FacilityId = "BB2", FuelType = FuelType.F8, Gearbox = Gearbox.G2, Leasable = false, Mileage = 11000, Used = true, Year = 2012, Price = 180000 },
                    new Vehicle { RegistrationNumber = "FLS922", MakeId = 37, Model = "A2", ModelDescription = "D1", BodyType = BodyType.B9, Colour="Silver", Horsepowers = 130, FacilityId = "BB1", FuelType = FuelType.F1, Gearbox = Gearbox.G1, Leasable = false, Mileage = 13000, Used = true, Year = 2005, Price = 35000 },
                    new Vehicle { RegistrationNumber = "LVC884", MakeId = 38, Model = "Hilux", ModelDescription = "1.2", BodyType = BodyType.B1, Colour="Vit", Horsepowers = 150, FacilityId = "BB1", FuelType = FuelType.F1, Gearbox = Gearbox.G1, Leasable = true, Mileage = 13000, Used = true, Year = 2015, Price = 220000 },
                    new Vehicle { RegistrationNumber = "HSK563", MakeId = 31, Model = "Astra K", ModelDescription = "3.2", BodyType = BodyType.B1, Colour="Röd", Horsepowers = 148, FacilityId = "BB2", FuelType = FuelType.F1, Gearbox = Gearbox.G1, Leasable = true, Mileage = 34000, Used = true, Year = 2014, Price = 130000 },
                    new Vehicle { RegistrationNumber = "KSD342", MakeId = 29, Model = "9-5", ModelDescription = "2.2 Turbo", BodyType = BodyType.B1, Colour="Svart", Horsepowers = 183, FacilityId = "BB2", FuelType = FuelType.F1, Gearbox = Gearbox.G1, Leasable = false, Mileage = 44000, Used = true, Year = 2002, Price = 18000 },
                    new Vehicle { RegistrationNumber = "TWD702", MakeId = 33, Model = "Lexus RX", ModelDescription = "1.4", BodyType = BodyType.B1, Colour="Svart", Horsepowers = 313, FacilityId = "BB2", FuelType = FuelType.F1, Gearbox = Gearbox.G2, Leasable = false, Mileage = 14000, Used = true, Year = 2008, Price = 99000 },
                    new Vehicle { RegistrationNumber = "APA007", MakeId = 5, Model = "Agera S", ModelDescription = "5.0L V8, dual Turbo", BodyType = BodyType.B8, Colour="Mörkgrön", Horsepowers = 1341, FacilityId = "BB1", FuelType = FuelType.F1, Gearbox = Gearbox.G2, Leasable = false, Mileage = 3600, Used = false, Year = 2013, Price = 4999000 },
                    new Vehicle { RegistrationNumber = "APA007", MakeId = 41, Model = "Bobby Car", ModelDescription = "Dual-leg Kicker", BodyType = BodyType.B8, Colour="Röd", Horsepowers = 1, FacilityId = "BB3", FuelType = FuelType.F9, Gearbox = Gearbox.G1, Leasable = true, Mileage = 1, Used = true, Year = 1998, Price = 600 },
                };
